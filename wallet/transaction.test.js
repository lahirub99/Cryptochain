...
describe('Transaction', () => {
    ...
    describe('outputMap', () => {
     ...
     describe('input', () => {
        ...
        it('sets the `amount` to the `senderWallet` balanece', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('substracts the amount from the original sender amount', () => {
                expect( transaction.outputMap[senderWallet.publicKey] )
                    .toEqual( originalSenderOutput - nextAmount );
            });
    
            it('maintains a total output that matches the input amout', () => {
                expect(
