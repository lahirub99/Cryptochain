...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                ...
                blockchain.addBlock({ data: 'Monica' });
                blockchain.addBlock({ data: 'Chandler' });
            });
    ...
    describe('replace chain()', () => {
        ...
        describe('when the new chain is not longer', () => {
            beforeEach(() => {
                newChain.chain[0] = { new: 'chain' };    //  Replacing the chain with smth with same length
        ...
        describe('when the new chain is longer', () => {
            beforeEach(() => {
                ...
                newChain.addBlock({ data: 'Monica' });
                newChain.addBlock({ data: 'Chandler' });
            });
